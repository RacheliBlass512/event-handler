        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromAssigneeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ToAssigneeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventHistory_EventId_ChangedAt",
                table: "EventHistory",
                columns: new[] { "EventId", "ChangedAt" });
